...
const WaterfallLayout = () => {
  ...
  useEffect(() => {
    ...
    if (filters.price !== 'all') {
      const priceRange = PRICE_RANGES.find(range => range.id === filters.price);
      if (priceRange) {
      ...
      <div className={styles.filterGroup}>
        ...
        <div className={styles.filterButtonsContainer}>
          ...
          <button
            ...
            className={`${styles.filterButton} ${styles.nextButton} ${currentPage === totalPages ? styles.disabled : ''}`}
          >
      ...
      <div className={styles.filterGroup}>
        ...
        <div className={styles.filterButtonsContainer}>
          ...
          {PRICE_RANGES.map(range => (
            <button
              key={range.id}
              className={`${styles.filterButton} ${filters.price === range.id ? styles.active : ''}`}
              onClick={() => {
      ...
      <div className={styles.filterGroup}>
        ...
        <div className={styles.filterButtonsContainer}>
          ...
          {TIME_RANGES.map(range => (
            <button
              key={range.id}
              className={`${styles.filterButton} ${filters.time === range.id ? styles.active : ''}`}
              onClick={() => {
          ...
          <div className={styles.activeFilters}>
            {filters.category !== 'all' && (
              <span className={styles.filterTag}>
                {MUSIC_CATEGORIES.find(cat => cat.id === filters.category)?.name}
              </span>
            )}
            {filters.price !== 'all' && (
              <span className={styles.filterTag}>
                {PRICE_RANGES.find(range => range.id === filters.price)?.label}
              </span>
            )}
            {filters.time !== 'all' && (
              <span className={styles.filterTag}>
